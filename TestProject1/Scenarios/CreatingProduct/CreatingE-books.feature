Feature: CreatingE-book

@Product_Management
Scenario:1 Creating E-Book Product     
    Given I am logged in Ingenta Commercial Application
    When I click on Customer Service
    And I click on New Product from Customer Services
    And I select "E-Book" from Product Types
    And I enter Title prefix "Ebook"
    And I enter Without prefix
    And I enter imprint "Reef Books"
    And I click Finish
    And I set a Primary Identifier for E-Book
...
@Product_Management    
Scenario:2 Creating E-Book Product with Child product 
    Given I am logged in Ingenta Commercial Application
    When I click on Customer Service
    And I click on New Product from Customer Services
    And I select "E-Book" from Product Types
    ...
    And I enter a Primary Identifier for E-Book  
...
@Product_Management    
Scenario:3 Creating E-Book Product with Parent product
    Given I am logged in Ingenta Commercial Application
    When I click on Customer Service
    And I click on New Product from Customer Services
    And I select "E-Book" from Product Types
