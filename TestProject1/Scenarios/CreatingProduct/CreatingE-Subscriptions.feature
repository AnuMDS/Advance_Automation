Feature: CreatingE-Subscriptions

@Product_Management
Scenario:1 Creating E-Subscription Products     
    Given I am logged in Ingenta Commercial Application
    When I click on Customer Service
    And I click on New Product from Customer Services
    And I select "Online Subscription" from Product Types
    And I enter Title prefix "E-Subscription"
    And I enter Without prefix
    And I enter imprint "Reef Books"
    And I click Finish
    And I set a Primary Identifier for E-Subscription
...
@Product_Management  
Scenario:2 Creating E-Subscription Product with Child product 
    Given I am logged in Ingenta Commercial Application
    When I click on Customer Service
    And I click on New Product from Customer Services
    And I select "Online Subscription" from Product Types
    ...
    And I enter a Primary Identifier for E-Subscription
...
@Product_Management   
Scenario:3 Creating E-Subscription Product with Parent product
    Given I am logged in Ingenta Commercial Application
    When I click on Customer Service
    And I click on New Product from Customer Services
    And I select "Online Subscription" from Product Types
