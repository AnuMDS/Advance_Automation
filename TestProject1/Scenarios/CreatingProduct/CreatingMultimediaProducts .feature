Feature: CreatingMultimediaProducts 

@Product_Management
Scenario:1 Creating Multimedia Product     
    Given I am logged in Ingenta Commercial Application
    When I click on Customer Service
    And I click on New Product from Customer Services
    And I select "DVD" from Product Types
    And I enter Title prefix "DVD"
    And I enter Without prefix
    And I enter imprint "Reef Books"
    And I click Finish
    And I set a Primary Identifier
...
@Product_Management    
Scenario:2 Creating Multimedia Product with Child product
    Given I am logged in Ingenta Commercial Application
    When I click on Customer Service
    And I click on New Product from Customer Services
    And I select "DVD" from Product Types
    ...
    And I enter a Primary Identifier    
...
@Product_Management 
Scenario:3 Creating Multimedia Product with Parent product  
    Given I am logged in Ingenta Commercial Application
    When I click on Customer Service
    And I click on New Product from Customer Services
    And I select "DVD" from Product Types
