Feature: GoodsInMiscellaneous

#This feature file contains automated manual tests of RAVAUT-702 on Jira
#Select product of type - Books
@InventoryManagement
  Scenario: Updating inventory with goods in transaction without any supplier order.
  Given I am logged in Ingenta Commercial Application
  When I click on Inventory
  And I verify the product "Great Barrier reef" to Goods In
  ...
  And I enter a message in the Comments "Goods in Miscellaneous"
